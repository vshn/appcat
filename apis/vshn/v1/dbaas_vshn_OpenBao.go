...
//go:generate yq -i e ../../generated/vshn.appcat.vshn.io_vshnopenbaoes.yaml --expression "with(.spec.versions[]; .schema.openAPIV3Schema.properties.spec.properties.parameters.properties.tls.default={})"
...
type VSHNOpenBaoParameters struct {
	...
	TLS VSHNOpenBaoTLSSpec `json:"tls,omitempty"`
