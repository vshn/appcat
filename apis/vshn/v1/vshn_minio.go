...
func (v *VSHNMinio) GetInitialMaintenanceRan() bool {
	return v.Status.InitialMaintenance.CompletedAt != nil
}

func (v *VSHNMinio) GetInitialMaintenanceCompletedAt() string {
...
func (v *VSHNMinio) SetInitialMaintenanceStatus(completedAt string, success bool) {
