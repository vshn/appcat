...
// GetItems of this VSHNPostgreSQLCNPGList.
func (l *VSHNPostgreSQLCNPGList) GetItems() []resource.Managed {
...
// GetItems of this VSHNPostgreSQLList.
func (l *VSHNPostgreSQLList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
...
// GetItems of this XVSHNNextcloudList.
func (l *XVSHNNextcloudList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
...
// GetItems of this XVSHNPostgreSQLCNPGList.
func (l *XVSHNPostgreSQLCNPGList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
