...
import (
	...
	vshnpostgres "github.com/vshn/appcat-apiserver/comp-functions/functions/vshn-postgres-func"
...
func init() {
	grpcCommand.Flags().StringVar(&Network, "network", "unix", "network type")
	grpcCommand.Flags().StringVar(&AddressFlag, "socket", "@crossplane/fn/default.sock", "set where socket should be located")
}
...
var postgresFunctions = []runtime.Transform{
	{
		...
		TransformFunc: vshnpostgres.AddUrlToConnectionDetails,
	},
	{
		Name:          "user-alerting",
		TransformFunc: vshnpostgres.AddUserAlerting,
	},
	{
		Name:          "random-default-schedule",
		TransformFunc: vshnpostgres.TransformSchedule,
	},
	{
		Name:          "encrypted-pvc-secret",
		TransformFunc: vshnpostgres.AddPvcSecret,
	},
}
