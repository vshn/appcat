...
replace (
	github.com/deepmap/oapi-codegen => github.com/sljeff/oapi-codegen v1.5.1-0.20211207091501-bc20f55d338a
	github.com/openshift/machine-config-operator => github.com/openshift/machine-config-operator v0.0.1-0.20230508173032-8f952d7fd139
)
...
require (
	...
	github.com/appuio/openshift-upgrade-controller v0.5.2
