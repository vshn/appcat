...
// AddKeycloakVersionCompatCheck flags and surfaces a version/revision
// incompatibility on the claim.
func AddKeycloakVersionCompatCheck(ctx context.Context, comp *vshnv1.VSHNKeycloak, svc *runtime.ServiceRuntime) *xfnproto.Result {
	...
	res := compat.RunCompatCheck(ctx, svc, "keycloak",
