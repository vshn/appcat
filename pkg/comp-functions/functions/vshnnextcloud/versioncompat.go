...
// AddNextcloudVersionCompatCheck flags and surfaces a version/revision
// incompatibility on the claim.
func AddNextcloudVersionCompatCheck(ctx context.Context, comp *vshnv1.VSHNNextcloud, svc *runtime.ServiceRuntime) *xfnproto.Result {
	...
	res := compat.RunCompatCheck(ctx, svc, "nextcloud",
