...
func createCnpgHelmValues(ctx context.Context, svc *runtime.ServiceRuntime, comp *vshnv1.VSHNPostgreSQL) (map[string]any, error) {
	const psqlContainerRegistry = "ghcr.io/cloudnative-pg/postgresql:"
	...
	values := map[string]any{
		...
		"imageCatalog": map[string]any{
			...
			"images": []map[string]string{
				{
					"image": psqlContainerRegistry + "17.5",
					"major": "17",
				},
				{
					"image": psqlContainerRegistry + "16.9",
					"major": "16",
				},
				{
					"image": psqlContainerRegistry + "15.9",
					"major": "15",
				},
			},
		},
