...
func (m *MockvshnPostgresqlProvider) ListXVSHNPostgreSQL(ctx context.Context, namespace string) (*vshnv1.XVSHNPostgreSQLList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListXVSHNPostgreSQL", ctx, namespace)
	ret0, _ := ret[0].(*vshnv1.XVSHNPostgreSQLList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
